...
genus_phate$embedding %>%
  merge(enterotypes, by.x="row.names", by.y="sample_name") %>%
  filter(Enterotypes_id %in% c(18,14,16,17,7)) %>% dim
  ...
  geom_text(data = enterotypes_phate_centroid, aes(x=PHATE1, y=PHATE2, label=Enterotypes_id))
