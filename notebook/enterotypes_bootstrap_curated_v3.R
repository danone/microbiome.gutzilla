...
save(fit_genus_list, file=paste0("fit_genus_list_",bootstrap,"_curated_v3.rda"))

}


## group all bootstrap within one file
fit_genus_bootstrap_curated = vector("list",5)
...
save(fit_genus_bootstrap_curated, file="fit_genus_bootstrap_curated_v3.rda")
