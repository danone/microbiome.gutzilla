...
genus_phate$embedding %>%
  ...
  ggrepel::geom_label_repel(data = enterotypes_phate_centroid, aes(x=PHATE1, y=PHATE2, label=Enterotypes_id)) -> fig1H
...
genus_phate$embedding %>%
  ...
  scale_color_viridis_c("GMHI", option="cividis") + cowplot::theme_cowplot() -> fig1F
#+
...
(((fig1A+ylab("alpha-\ndiversity"))/
 ...
 |
  ...
  (
    ...
    (fig1F/fig1E/fig1C/fig1D/(fig1H+cowplot::theme_cowplot())))
