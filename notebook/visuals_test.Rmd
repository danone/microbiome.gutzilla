...
url="data-raw/qiime/generated-files-20190512/beta/pcoa/b50e69a1-9732-4323-9541-8324e1715a7a/data/ordination.txt" #unweighted
...
```{r}
test %>%
  ggplot + geom_point(aes(pcoa1, pcoa2, color=log10(value+0.0001) ), size=1) +  facet_wrap(~Genus) + scale_color_viridis_c() 
