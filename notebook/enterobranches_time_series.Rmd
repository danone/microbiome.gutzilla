...
igraph::V(graph)$stability <-  enterotypes_time_series_stability$p         
igraph::V(graph)$branches <-  enterotypes_time_series_stability$branches 
  
  
ggraph(graph) +
  geom_edge_diagonal(aes(edge_width = p)) + 
  geom_node_label()
